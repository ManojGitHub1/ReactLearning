...
// props is a special object that is passed to every component in React
// function Card(props) {
    // console.log(props.username);
    // console.log(props.someObj.age);

function Card({username="Manya", someObj}) {
    ...
    return (
        ...
        {/* ACCESSING PROPS HERE FROM DIFFERENT CARD DIFFERENT VALUES */}
          <h2 class="font-semibold">{username}</h2>
          <p class="text-gray-500">Developer</p>
          <p class="text-gray-500">{someObj.age || "Age not from this card"}</p>
          <p class="text-gray-500">{someObj[1] || "Array not from this card"}</p>
        </div>
